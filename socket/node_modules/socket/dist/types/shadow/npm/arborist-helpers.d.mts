...
import type { AlertIncludeFilter, AlertsByPurl } from '../../utils/socket-package-alert.mts';
import type { EditablePackageJson } from '@socketsecurity/registry/lib/packages';
import type { Spinner } from '@socketsecurity/registry/lib/spinner';
export declare function findBestPatchVersion(node: NodeClass, availableVersions: string[], vulnerableVersionRange?: string): string | null;
...
export declare function getAlertsMapFromArborist(arb: ArboristInstance, options_?: GetAlertsMapFromArboristOptions | undefined): Promise<AlertsByPurl>;
